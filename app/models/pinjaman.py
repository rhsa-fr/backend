# ============================================================================
# FILE: app/models/pinjaman.py  — REPLACE existing file
# ============================================================================
...
class Pinjaman(Base):
    ...
    id_user_pengaju      = Column(Integer, ForeignKey("user.id_user",
                                  ondelete="SET NULL", onupdate="CASCADE"),
                                  comment="User yang input pengajuan")
    id_user_persetujuan  = Column(Integer, ForeignKey("user.id_user",
                                  ondelete="SET NULL", onupdate="CASCADE"),
                                  comment="Ketua yang menyetujui")
    ...
    user_pengaju       = relationship("User", back_populates="pinjaman_pengaju",
                                      foreign_keys=[id_user_pengaju])
    user_persetujuan   = relationship("User", back_populates="pinjaman_persetujuan",
                                      foreign_keys=[id_user_persetujuan])
