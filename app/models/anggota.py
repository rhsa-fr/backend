...
class Anggota(Base):
    ...
    status = Column(Enum(StatusAnggota), default=StatusAnggota.AKTIF, index=True)
    created_at = Column(TIMESTAMP, server_default=func.current_timestamp())
    updated_at = Column(TIMESTAMP, server_default=func.current_timestamp(), onupdate=func.current_timestamp())
    
    # Relationships
    profil = relationship("ProfilAnggota", back_populates="anggota", uselist=False, cascade="all, delete-orphan")
